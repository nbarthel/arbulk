...
class ShipmentEntryForm extends React.Component {
   ...
   //React.unmountComponentAtNode(document.getElementById(''));}
    ...
    isValid(){
        debugger
        const { errors , isValid } = validateInput(this.SIObj);
        if(!isValid){
            this.setState({
                errors : errors
            })
 ...
 isValidDomestic(){
        debugger
        const { errorsd , isValid } = validateDomesticInput(this.Domesticobj);
        if(!isValid){
    ...
    isValidInt(){
        debugger
        const { errorsI , isValid } = validateInternationalInput(this.Internationalobj);
        if(!isValid){
    ...
    onSubmit(e){
        ...
        if(this.state.lotInfoList.length == 0 && this.comPo.lot_id != ''){
            this.LIObjects.push(_.cloneDeep(this.comPo))
        }
        if(this.state.lotInfoList.length > 0 && this.comPo.lot_id != ''){
            this.LIObjects.push(_.cloneDeep(this.comPo))
                                    ...
                                    <fieldset className="scheduler-border  tab-pane active" id="International">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="Type_of_Pallet"
                                                   className={this.state.errorsI.steamshipVessel ? "col-lg-5  col-md-5 col-sm-11  col-xs-11 control-label has error":"col-lg-5  col-md-5 col-sm-11  col-xs-11 control-label"}>Steamship
                                                Vessel</label>
                                            ...
                                            <div className="col-lg-6    col-sm-11 col-xs-11 ">
                                                <div className="right-inner-addon "><i className="fa fa-calendar"
                                                    ...
                                                    <DatePicker
                                                        ...
                                                        className = "form-control"
                                                        name="earliestReturnDate"
                                                        onChange={this.InternationalReturnDate}placeholderText="EarliestReturnDate"/>
                                                </div>
                                                <div className="error"><span></span></div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-lg-6   col-sm-11 col-xs-11 ">
                                                <div className="right-inner-addon "><i className="fa fa-calendar"
                                                    ...
                                                    <DatePicker
                                                        ...
                                                        className = "form-control"
                                                        name="docCutoffDate"
                                                        onChange={this.DocCutOffDate}placeholderText="Doc Cutoff Date/Time"/>
                                                </div>
                                                <div className="error"><span></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="col-lg-6    col-sm-11 col-xs-11 ">
                                                <div className="right-inner-addon "><i className="fa fa-calendar"
                                                    ...
                                                    <DatePicker
                                                        dateFormat="MM-DD-YYYY"
                                                        selected={this.state.CargoCutoffDate}
                                                        className = "form-control"
                                                        name="cargoCutoffDate"
                                                        onChange={this.InternationalCargoDate}placeholderText="CargoCutoff Date"/>
                                                </div>
                                                <div className="error"><span></span></div>
                                            </div>
                                        </div>
