			...
			<fieldset className="scheduler-border sameHeight-Domestic ">
				...
				<div className="form-group">
					...
					<select className="form-control" id="" name="Type_of_Packaging" disabled>
						<option value = {this.props.data.TCompany.id}>{this.props.data.TCompany.name}</option>						
					  </select>								 
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					  <input type="text" className="form-control" value = {this.props.data.releaseNumber} disabled id="Purchase_Order" placeholder="Release #"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group ">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					  <input type="text" disabled className="form-control" id="Rail_Car_Number" placeholder="Purchase Order Number"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">		
						<label className="control control--checkbox ">Confirmed
			    ...
			    <div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					     <input type="text" className="form-control" disabled value = {this.props.data.TShipmentLots[0].TPackagingInstructionLots.length > 0 ? this.props.data.TShipmentLots[0].TPackagingInstructionLots[0].lot_number : null} id="Lot_Number" placeholder="Lot Number"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="pddn-100-top"> 
						<div className="form-group">
							...
							<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
							   <input type="text" disabled className="form-control" id="" placeholder="Material"/>
							  <div className="error"><span></span></div>
							</div>
							<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">				
								<label className="control control--checkbox ">Confirmed
						...
						<div className="form-group ">
							...
							<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
							   <select className="form-control" disabled id="Type_of_Packaging" name="Type_of_Packaging">
								<option value = {this.props.data.numberOfContainers}>{this.props.data.numberOfContainers}</option>
							  </select>
							  <div className="error"><span></span></div>
							</div>
							<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
    ...
    <div className=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
	    ...
	    <fieldset className="scheduler-border sameHeight-Domestic">
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					  <input type="text" className="form-control" value = {this.props.data.TShipmentDomestic[0].bookingNumber} disabled id="" placeholder="Booking Numbere"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">		
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<select className="form-control" id="" name="" disabled>
						<option value="">{this.props.data.TShipmentDomestic[0].TShipmentType.shipmentType}</option>
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					  <input type="text" className="form-control" value = {this.props.data.TShipmentDomestic[0].shippingReferenceNumber} disabled id="" placeholder="Shipping Ref Number"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">		
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					  <input type="text" className="form-control" value = {this.props.data.TShipmentDomestic[0].recipent} disabled id="" placeholder="Reciepient"/>
					  <div className="error"><span></span></div>
					</div>
				<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					  <input type="text" className="form-control" id="" value = {this.props.data.TShipmentDomestic[0].recipentContact} disabled placeholder="Reciepient Contact"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					    <input type="text" className="form-control" id="" value = {this.props.data.TShipmentDomestic[0].recipentTelNumber} disabled placeholder="Reciepient Telephone"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="pddn-50-top">
					...
					<div className="form-group">
						<div className="col-lg-3 "><label htmlFor="" className=" control-label">Ship to Address 1</label></div>
						<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
							<input type="text" className="form-control" id="" placeholder="Ship to Address 1"/>
						  <div className="error"><span></span></div>
						</div>
						<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
							<label className="control control--checkbox ">Confirmed
					...
					<div className="form-group">
						...
						<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
							<input type="text" className="form-control" id="" placeholder="Ship to Zip Code"/>
						  <div className="error"><span></span></div>
						</div>
						<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
							<label className="control control--checkbox ">Confirmed
					...
					<div className="form-group">
						...
						<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
							<input type="text" className="form-control" id="" placeholder="Ship to City"/>
						  <div className="error"><span></span></div>
						</div>
						<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
							<label className="control control--checkbox ">Confirmed
					...
					<div className="form-group">
						...
						<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
							<input type="text" className="form-control" id="" placeholder="Ship to State"/>
						  <div className="error"><span></span></div>
						</div>
						<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
							<label className="control control--checkbox ">Confirmed
					...
					<div className="form-group">
						<div className="col-lg-3 "><label htmlFor="" className=" control-label">Reciepient Telephone</label></div>
						<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
							<input type="text" className="form-control" id="" placeholder="Reciepient Telephone"/>
						  <div className="error"><span></span></div>
						</div>
						<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
							<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					    <input type="text" value = {this.props.data.TShipmentDomestic[0].carrier} disabled className="form-control" id="" placeholder="Carrier"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					    <input type="text" className="form-control" id="" value = {this.props.data.TShipmentDomestic[0].carrierAcNumber} disabled  placeholder="Carrier Account Number"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					    <input type="text" className="form-control" id="" value = {this.props.data.TShipmentDomestic[0].TPaymentType.type} disabled placeholder="Shipping Payment Type"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					    <input type="text" className="form-control" value = {this.props.data.TShipmentDomestic[0].paidBy} disabled id="" placeholder="Shipping Paid By"/>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
						<label className="control control--checkbox ">Confirmed
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					   <div className="right-inner-addon "><i className="fa fa-calendar" aria-hidden="true"></i>
						<input className="form-control" id="date" value = {moment(this.props.data.TShipmentDomestic[0].requestedShipDate).format("MM-DD-YYYY")}  disabled name="date" placeholder="Requested Ship Date" type="text"/>
					</div>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
				...
				<div className="form-group">
					...
					<div className="col-lg-6 col-md-6 col-sm-8 col-xs-12 ">
					 <div className="right-inner-addon "><i className="fa fa-calendar" aria-hidden="true"></i>
						<input className="form-control" id="date" name="date" value = {moment(this.props.data.TShipmentDomestic[0].requestedDeliveryDate).format("MM-DD-YYYY")} disabled placeholder="Requested Delivery Date" type="text"/>
					</div>
					  <div className="error"><span></span></div>
					</div>
					<div className=" col-lg-2 col-md-2 col-sm-4 col-xs-2 pddn-10-top">			
