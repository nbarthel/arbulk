...
class AddMaterialBags extends Component {
	componentWillReceiveProps(){
		debugger
		for(var i in this.props.unitType){
			if(this.props.unitType[i].id == this.props.packagingTypeId){
				this.setState({
					PackName : this.props.unitType[i].packagingType
				})
				this.forceUpdate()
				break;
			}
	...
	render() {
		...
		for(var i in this.props.unitType){
			if(this.props.unitType[i].id == this.props.packagingTypeId){
					this.PackName = this.props.unitType[i].packagingType
				break;
			}
		}
		return (
			<div >
						<div className=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div className="form-group">
								...
								<div className=" col-lg-6 col-md-6 col-sm-6 col-xs-12">	<label htmlFor="" >{this.props.packagingTypeId==1?"Avg. Weight of Material (kg)":"Avg. Weight of Material (lbs)"}</label>
								<input type="text"
								className="form-control"
							...
							<div className="form-group">
									<div className=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<label htmlFor="" >{"No. of Active " +this.PackName}</label>
									<input type="text"
									className="form-control"
									id="ActiveBags"
									onChange = {this.onBagsInput}
