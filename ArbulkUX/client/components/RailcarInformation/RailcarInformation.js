			...
			<div className={this.props.id===0?" ":"RailCarAdd"}>
				<div className="form-group ">
					...
					{this.props.haveProps=="1"?
						...
						this.props.addkey.length -1 == this.props.idd ?
						<div id={this.props.idForadd} className="col-lg-1 col-md-1 col-sm-1 col-xs-1 add_btn text_left">
							<i className="fa-2x fa fa-plus base_color" onClick={this.props.onAdd} aria-hidden="true"></i>
						</div>:""}
						...
						this.props.haveProps=="1"?
							...
							this.props.addkey.length -1 == this.props.idd ?
								<div className="col-lg-1 col-md-1 col-sm-1 col-xs-1 add_btn text_left">
									<i className="fa-2x fa fa-minus base_color" onClick={this.props.onMinus} aria-hidden="true"></i>
								</div>:""
					}
