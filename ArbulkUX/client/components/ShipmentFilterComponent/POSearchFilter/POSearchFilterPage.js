                    ...
                    <div className="">
                        ...
                        <div className="">
                            <div className="left-inner-addon ">
                                ...
                                <input type="search" id="POSearch" value = {this.state.poValue} onKeyUp={this.onKeyUp}  onChange = {this.props.onTextChange} className="form-control" placeholder="Search" />
