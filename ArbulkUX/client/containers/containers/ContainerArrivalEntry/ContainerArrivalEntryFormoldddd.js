...
onSave(e){
  ...
  this.postObj.trackingNumber = this.trackNumber
                          ...
                          <fieldset className="scheduler-border   sameHeight" >
                            ...
                            <div className="form-group">
                              ...
                              <div className="form-group ">
                                  ...
                                  <label htmlFor="Container" className="col-lg-6 control-label">Seal #</label>
                                  <div className="col-lg-6">
                                      <input type="text" className="form-control" onChange = {this.onContainerChange}  id="Container_int" placeholder="Seal #" />
                                      <div className="error"><span></span></div>
                                  </div>
                              </div>
