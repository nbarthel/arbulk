/**
 * Created by Anurag on 10-11-2016.
 */
...
class  ContainerArrivalEntryForm extends React.Component {
    ...
    getPonumber(id){
        ...
        debugger;
        var loadPo = createDataLoader(ContainerArrivalEntryForm,{
            queries:[{
        ...
        var base = "TpackagingInstructionLots/"+id
        var poUrl = loadPo._buildUrl(base ,{
    ...
    isIValid(){
        const{ intErrors , isValid } = validateIntInput(this.IntPostObj)
        if(!isValid){
            this.setState({
                intErrors : intErrors
            })
    ...
    collectPoArray(arr){
        ...
        if(arr && arr.length > 0){
            for(var j in arr){
                this.poArray.push(arr[j].TPackagingInstructions.po_number)
            }
            console.log("this.poArraythis.poArraythis.poArray" , this.poArray)
        }
                                        ...
                                        <div className=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <fieldset className="scheduler-border   sameHeight" >
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <input type="text" className="form-control" id="Container_Tare_Weight" onChange = {this.onContainerTChange} placeholder="Container Tare Weight" />
                                                        <div className="error"><span></span></div>
                                                    </div>
                                                </div>
                                    ...
                                    <div id="Domestic" className={this.IsDomestic ? " active  tab-pane" :'tab-pane'}>
                                        <div className=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <fieldset className="scheduler-border   sameHeight" >
                                                ...
                                                <div className="form-group ">
                                                    <div  className="col-lg-6"><label htmlFor="Booking" className={this.state.domesticErrors.shipmentId ?"control-label has error" : "control-label"}>Domestic Booking</label></div>
                                                    <div className="col-lg-6">
                                                        <select className="form-control" id="Booking" onChange = {this.onBookingChange} name="Booking">
