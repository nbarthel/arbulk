                                ...
                                <div className="  col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                    <fieldset className="scheduler-border sameHeight">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="Customer" className="col-lg-4 control-label">Customer</label>
                                        ...
                                        <div className="form-group ">
                                            <div  className="col-lg-4"><label htmlFor="Booking" className=" control-label">Domestic Booking</label></div>
                                            <div className="col-lg-8">
                                        ...
                                        <div className="form-group ">
                                            <label htmlFor="Dropoff_Trucker" className="col-lg-4 control-label">Dropoff Trucker</label>
                                            <div className="col-lg-8">
                                        ...
                                        <div className="form-group ">
                                            <label htmlFor="P_U_Trucker" className="col-lg-4 control-label">P / U Trucker</label>
                                            <div className="col-lg-8">
                                        ...
                                        <div className="form-group ">
                                            ...
                                            <label htmlFor="Container" className="col-lg-4 control-label">Container #</label>
                                            <div className="col-lg-8">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="Chassis" className="col-lg-4 control-label">Chassis #</label>
                                            <div className="col-lg-8">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="Container_Tare_Weight" className="col-lg-4 control-label">Container Tare Weight</label>
                                            <div className="col-lg-8">
