...
class ShipmentList extends React.Component {
    ...
    {
        hashHistory.push("/Admin/updateShipmentType/"+scratchID);
    }
    ...
    deactivate(ID)
    {
        axios.put(Base_Url+"TShipmentTypes/"+ID,{"active": 0}).then((response)=>{
            swal({
                title: "Success",
                text: "Shipment type deleted successfully.",
                type: "success",
