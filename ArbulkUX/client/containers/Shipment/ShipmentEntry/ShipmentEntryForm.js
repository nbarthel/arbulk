...
class ShipmentEntryForm extends React.Component {
    constructor(props) {
        ...
        this.internationalCargoCutOffDate=tempDate.getFullYear()+"-"+(parseInt(tempDate.getMonth())+1)+"-"+tempDate.getDate()+" "+"00:00"
        this.DocCutoffDate=tempDate.getFullYear()+"-"+(parseInt(tempDate.getMonth())+1)+"-"+tempDate.getDate()+" "+"00:00"
        this.minus=0;
        this.lotminus=0;
        this.poNumber
        this.lotNumber
