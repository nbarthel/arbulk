    ...
    tableCheckBoxChange(e,value){
        ...
        if(e.target.checked) {
            ...
            axios.get(this.url).then((response)=>{
                ...
                this.unallocatedcontainer=response.data.numberOfContainers
                this.b = response.data.TContainerAllocation;
...
//  alert(e.target.getAttribute('value'))
    ...
    onConfirmClick(e){
        ...
        //console.log("prop",this.props.pckData);
        console.log("prop",this.shipmentId );
        //
        if(this.props.data.isDomestic==1){
            if(this.props.data.TShipmentDomestic[0].status == "UNCONFIRMED"){
            ...
            if(this.props.data.TShipmentInternational[0].status == "UNCONFIRMED"){
                hashHistory.push('/Shipment/shipmentConfirmation/'+this.confid)
            }
            else{
                swal("Error","Order has already been confirmed","error")
    ...
    print(e){
        ...
        if( this.shipmentId!= undefined){
            ...
            hashHistory.push('/Shipment/shipmentPrint/'+this.shipmentId)
                                ...
                                <div className="panel panel-default">
                                    ...
                                    <div id="ContainerSummary" className="panel-collapse collapse in">
                                        ...
                                        <div className="table-responsive">
                                            ...
                                            <div className="more_load" style={{display:(parseInt(this.unallocatedcontainer) - parseInt(this.unAllacated) == 0)?'none' :'block' }}>
                                        ...
                                        <div className="text_left pddn-10-top" style={{display : this.state.showEdit}}>
                                            <div className="pull-left margin-10-last-l"><button type="button"  className="btn btn-sm  btn-gray" onClick = {(e) => {this.print(e)}}>Print Load Order</button> </div>
