				...
				<div className=" ">				
					<div className="pull-left pddn-10-top ">					
						 ...
						 <div className="right-inner-addon "><i className="fa fa-calendar" aria-hidden="true"></i>				
							<input className="form-control" id="date" name="date" placeholder="Railcar Departure Date" type="text"/>
						</div>
						</div>						
					</div>					
				    <div className="pull-right padding-top-btm-xs"> 					
						<div className="pull-right padding-10-last-r"><button type="button"  className="btn  btn-primary">DEPARTED </button></div>
