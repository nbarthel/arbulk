...
export default class RailcarArrivalEntryForm extends React.Component {
    ...
    updateCartArrival(){
        ...
        var option = {
            ...
            railcar_departed_on : parseInt(this.state.startDate._d.getMonth()) +1 +'/'+this.state.startDate._d.getDate()+'/' +this.state.startDate._d.getFullYear()+' '+this.state.startDate._d.getHours()+':'+this.state.startDate._d.getMinutes()+':'+this.state.startDate._d.getSeconds()
        }
										...
										<div className="pull-right padding-top-btm-xs">
											...
											<div className="pull-right padding-10-all">	<div className="right-inner-addon mw-200">{this.state.startDate===''?<i style={{right:25}}>RailCar Departure Date</i>:''}<i className="fa fa-calendar" aria-hidden="true"></i>
												...
												<Datetime
													...
													onChange={(x, event) => this.handleChange1(x,event)}/>	</div>
											</div>
										</div>
									</div>
