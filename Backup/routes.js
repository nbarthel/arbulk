...
import ContainerArrivalEntryPage from './containers/containers/ContainerArrivalEntry/ContainerArrivalEntryPage';
import ContainerViewPage from './containers/containers/ContainerView/ContainerViewPage';
import ContainerQueueViewPage from './containers/containers/ContainerQueueView/ContainerQueueViewPage';
 export default (
	<Route path="/">
	...
	<Route path="containerarrivalentry" component={ContainerArrivalEntryPage} />
	<Route path="containerview" component={ContainerViewPage} />
	<Route path="containerqueueview" component={ContainerQueueViewPage} />
	</Route>
